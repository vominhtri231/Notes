* Pluggable database (PDB) is introduced from Oracle 12c. It is a collection of portable shemas and objects that appear to clients as a separate database. DBA_PDBS will list the pluggable databases.
